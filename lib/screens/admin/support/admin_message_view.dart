...
import '../../support/components/message_item.dart';

class AdminMessageView extends StatelessWidget {
  AdminMessageView({super.key,required this.ticket,required this.backCallBack});
                  ...
                  children: [
                    Consumer<SupportController>(
                      builder: (context, supportCtr, child) {
                        List<TicketMessage> messages=supportCtr.adminTicketMessages[ticket.id]??[];
                          ...
                          if(_formKey.currentState!.validate()){
                            try{
                              ...
                              if(credential!=null){
                                ...
                                await supportController.addReply(credential: credential, ticketId: ticketId,receiverUid: receiverUid, message: message, imageUrl: imageUrl, isMedia: isMedia);
                              ...
                              log(e.toString());
                              ShowSnackBar.show(context, "Unable to add reply", Colors.red);
                              addingMessageNotifier.value=false;
                            }
                          }
                        },
