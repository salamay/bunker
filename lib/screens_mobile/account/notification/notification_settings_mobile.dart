...
class NotificationSettingsMobile extends StatefulWidget {
  NotificationSettingsMobile({super.key});

  @override
  State<NotificationSettingsMobile> createState() => _NotificationSettingsMobileState();
}

class _NotificationSettingsMobileState extends State<NotificationSettingsMobile> {
